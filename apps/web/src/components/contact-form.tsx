    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-2xl p-8 text-center animate-in fade-in zoom-in-95">
        ...
        <p className="text-green-700 font-medium">
          Merci de nous avoir contactés. Notre équipe reviendra vers vous sous
          24h.
        </p>
        <Button
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Input
            id="name"
            {...register("name")}
            className="h-12 rounded-xl bg-muted/5 border-border"
      ...
      <div className="space-y-2">
        ...
        <Textarea
          id="message"
          {...register("message")}
          className="min-h-[150px] rounded-xl bg-muted/5 border-border resize-none"
