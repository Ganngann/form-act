...
export function ProofUploadWidget({
    ...
    return (
      <Card className="rounded-[2rem] border-green-200 bg-green-50/50 shadow-sm overflow-hidden">
        <CardContent className="p-8 text-center flex flex-col items-center justify-center space-y-4">
          ...
          <div>
            <h3 className="text-xl font-black text-green-800 mb-1">
              Preuve Reçue
            </h3>
          ...
          <Button
            asChild
            variant="outline"
            className="bg-white border-green-200 text-green-700 hover:bg-green-100 hover:text-green-800 rounded-xl mt-4 font-bold"
          >
            <a
  ...
  return (
    <Card
      className="rounded-[2rem] border-dashed border-2 border-border shadow-none bg-muted/5 group hover:border-primary/50 transition-colors cursor-pointer"
      {...getRootProps()}
    >
      <input {...getInputProps()} />
      <CardContent className="p-8 flex flex-col items-center justify-center text-center min-h-[250px]">
        {uploading ? (
          ...
          >
            <div
              className={cn(
                "h-16 w-16 rounded-2xl flex items-center justify-center mx-auto transition-colors",
                isDragActive
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm max-w-[200px] mx-auto leading-relaxed">
                <span className="font-bold text-primary">Cliquez</span> ou
                glissez votre feuille de présence signée ici.
              </p>
            </div>
