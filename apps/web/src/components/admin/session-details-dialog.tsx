      ...
      <DialogContent aria-describedby={undefined}>
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <span
              className={`px-2 py-1 rounded text-xs font-semibold border ${STATUS_COLORS[computedStatus]}`}
            >
          ...
          <div className="grid gap-1">
            ...
            <span>
              {session.location || "À définir (En attente logistique)"}
            </span>
          </div>
          ...
          <div className="grid gap-1">
            ...
            <span>
              {session.participants
                ? JSON.parse(session.participants).length + " inscrits"
                : "Liste vide"}
            </span>
          </div>
        </div>
