          ...
          <Table>
            <TableHeader className="bg-gray-50/50">
              <TableRow className="hover:bg-transparent border-gray-100">
                <TableHead className="pl-8 h-14 font-bold text-gray-600 uppercase text-xs tracking-wider">Formation</TableHead>
                <TableHead className="h-14 font-bold text-gray-600 uppercase text-xs tracking-wider">Catégorie</TableHead>
                <TableHead className="h-14 font-bold text-gray-600 uppercase text-xs tracking-wider">Type</TableHead>
                <TableHead className="h-14 font-bold text-gray-600 uppercase text-xs tracking-wider">Prix HT</TableHead>
                <TableHead className="h-14 font-bold text-gray-600 uppercase text-xs tracking-wider">État</TableHead>
              ...
              {filteredFormations.map((formation) => (
                ...
                >
                  ...
                  <TableCell className="py-4">
                    {formation.category ? (
                      <Badge variant="secondary" className="rounded-lg font-bold bg-gray-100 text-gray-600 hover:bg-gray-200 border-transparent">
                  ...
                  <TableCell className="py-4">
                    {formation.isExpertise ? (
                      <Badge className="rounded-lg font-bold bg-amber-100 text-amber-700 hover:bg-amber-200 border-transparent">Expertise</Badge>
                    ) : (
                      <Badge variant="outline" className="rounded-lg font-medium text-gray-500 border-gray-200">Standard</Badge>
                    )}
                  </TableCell>
