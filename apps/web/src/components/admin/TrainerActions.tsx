    ...
    <DropdownMenu>
      ...
      >
        ...
        <DropdownMenuItem className="p-0">
          <Link
            href={`/admin/trainers/${trainerId}`}
            className="cursor-pointer font-medium w-full flex items-center px-2 py-1.5 hover:bg-accent hover:text-accent-foreground rounded-sm"
          >
