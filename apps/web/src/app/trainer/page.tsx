      ...
      <div className="min-h-screen flex items-center justify-center bg-muted/10 p-4">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground font-medium">
            Impossible de charger les informations du formateur.
          </p>
        </div>
      </div>
    );
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            ...
            <p className="text-muted-foreground font-medium text-lg">
              Gérez vos missions, consultez vos plannings et accédez aux
              documents.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div>
          <div className="flex items-center gap-4 mb-8">
            ...
            <Badge
              variant="outline"
              className="text-xs font-bold px-3 py-1 bg-white border-border text-muted-foreground"
            >
                      ...
                      <CardContent className="p-0 flex flex-col md:flex-row">
                        ...
                        <div className="flex-1 p-6 md:p-8 flex flex-col justify-center">
                          <div className="flex flex-wrap items-center gap-3 mb-3">
                            <Badge
                              variant="secondary"
                              className="bg-muted text-muted-foreground hover:bg-muted font-bold tracking-wide uppercase text-[10px]"
                            >
                              {mission.slot === "AM"
                                ? "Matin"
                                : mission.slot === "PM"
