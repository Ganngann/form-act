...
async function getCalendarData() {
    ...
    const calendarRes = await fetch(`${API_URL}/trainers/${trainerId}/calendar-url`, {
        headers: { Cookie: `Authentication=${token}` },
        cache: 'no-store',
    });
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div className="flex flex-col md:flex-row items-center gap-6 mb-8">
                ...
                <div>
                    <h1 className="text-4xl font-black tracking-tighter text-gray-900 mb-2">Paramètres & Sync</h1>
                    <p className="text-muted-foreground font-medium text-lg">Gérez vos préférences et la synchronisation de vos outils.</p>
                </div>
            </div>
                ...
                <Card className="rounded-[2rem] border-border shadow-sm overflow-hidden bg-white">
                    <CardContent className="p-8">
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h2 className="text-xl font-black tracking-tight text-gray-900">Synchronisation Calendrier</h2>
                                <p className="text-muted-foreground text-sm font-medium">Connectez votre agenda personnel.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-blue-50/50 border border-blue-100 rounded-2xl p-6 mb-8">
                            <div className="flex gap-4">
                                ...
                                <div className="space-y-2">
                                    <h4 className="font-bold text-blue-900">Comment ça marche ?</h4>
                                    <p className="text-sm text-blue-800/80 leading-relaxed">
                                        En activant la synchronisation, vos missions Form-Act apparaîtront automatiquement dans votre Google Calendar, Outlook ou Apple Calendar via un abonnement iCal.
                                    </p>
                                </div>
                            </div>
                        </div>
