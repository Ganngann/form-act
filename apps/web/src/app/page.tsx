        ...
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
          ...
          <h1
            ...
            dangerouslySetInnerHTML={{ __html: sanitizeHtml(hero.title, {
              ...
              allowedAttributes: { 'a': ['href'], 'span': ['class', 'className'] }
            }) }}
          />
            ...
            <div className="md:col-span-2 md:row-span-2 p-12 bg-primary border-[1px] border-primary rounded-[3rem] flex flex-col justify-between group overflow-hidden relative shadow-2xl shadow-primary/30">
              <div className="relative z-10">
                ...
                <h3
                  ...
                  dangerouslySetInnerHTML={{ __html: sanitizeHtml(promo.title, {
                    allowedTags: ['b', 'i', 'em', 'strong', 'a', 'br', 'span'],
                    allowedAttributes: { 'a': ['href'], 'span': ['class', 'className'] }
                  }) }}
                />
          ...
          {values.map((v, i) => (
            <div key={i} className="flex flex-col gap-6">
              ...
              <h3
                ...
                dangerouslySetInnerHTML={{ __html: sanitizeHtml(v.title, {
                  allowedTags: ['b', 'i', 'em', 'strong', 'a', 'br', 'span'],
                  allowedAttributes: { 'a': ['href'], 'span': ['class', 'className'] }
                }) }}
              />
        ...
        <div className="bg-primary rounded-[4rem] p-12 md:p-32 text-center text-white relative overflow-hidden group">
          ...
          <div className="relative z-10 flex flex-col items-center">
            <h2
              ...
              dangerouslySetInnerHTML={{ __html: sanitizeHtml(cta.title, {
                allowedTags: ['b', 'i', 'em', 'strong', 'a', 'br', 'span'],
                allowedAttributes: { 'a': ['href'], 'span': ['class', 'className'] }
              }) }}
            />
