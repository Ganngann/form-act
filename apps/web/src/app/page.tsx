      ...
      <section className="container pt-20 px-4 md:pt-32">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground/80 max-w-2xl mb-14 leading-relaxed font-medium animate-in fade-in slide-in-from-bottom-6 duration-1000">
            La puissance du réseau Form-Act dans une interface moderne pour
            propulser vos talents vers de nouveaux sommets.
          </p>
          ...
          <div className="flex flex-col items-center gap-8 w-full animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-4">
              <Button
                asChild
                size="lg"
                className="h-16 px-10 text-lg font-black rounded-2xl shadow-2xl shadow-primary/20 transition-all hover:scale-105 active:scale-95"
              >
              ...
              <Button
                ...
                size="lg"
                asChild
                className="h-16 px-10 text-lg font-black border-2 border-border rounded-2xl hover:bg-primary/5 hover:border-primary transition-all hover:scale-105 active:scale-95"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[220px]">
          ...
          {userRole ? (
            <div className="md:col-span-2 md:row-span-2 p-10 bg-white border border-border rounded-[3rem] flex flex-col justify-between group hover:border-primary transition-all duration-500 shadow-sm relative overflow-hidden">
              <div className="absolute top-4 right-4 z-20">
                <span className="px-2 py-1 rounded bg-primary/10 text-primary text-[8px] font-black uppercase tracking-widest border border-primary/20">
                  Connecté
                </span>
              </div>
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground mt-4 font-medium max-w-xs">
                  Programmé pour le mois prochain. Vous pouvez déjà consulter
                  les ressources.
                </p>
              </div>
            ...
            <div className="md:col-span-2 md:row-span-2 p-12 bg-primary border-[1px] border-primary rounded-[3rem] flex flex-col justify-between group overflow-hidden relative shadow-2xl shadow-primary/30">
              <div className="relative z-10">
                <span className="text-[10px] font-black text-white/50 uppercase tracking-[2px]">
                ...
                <p className="text-white/80 font-medium text-lg max-w-sm mb-8">
                  Accédez à des programmes exclusifs et gérez votre croissance
                  dans une interface pensée pour la performance.
                </p>
              </div>
              <Button
                asChild
                variant="secondary"
                className="bg-white text-primary hover:bg-white/90 font-black rounded-2xl h-16 w-fit relative z-10 px-10 transition-transform hover:scale-105 text-lg"
              >
                <Link href="/login">
                  Rejoindre le Réseau <BadgeCheck className="ml-2 h-6 w-6" />
                </Link>
              </Button>
          ...
          <div className="md:col-span-2 p-8 bg-orange-50/30 border border-orange-100 rounded-[3.5rem] flex items-center justify-between group hover:border-primary transition-all">
            <div className="flex items-center gap-6">
              ...
              <div>
                <h4 className="text-2xl font-bold tracking-tight">
                  {userRole ? "Dossier incomplet" : "Demande de Devis"}
                </h4>
            ...
            <Button
              asChild
              size="icon"
              className="h-14 w-14 rounded-2xl bg-white text-primary hover:bg-white/90 border border-orange-100 shadow-sm shrink-0"
            >
              <Link
                href={userRole ? "/dashboard" : "mailto:contact@form-act.com"}
              >
          ...
          <div className="p-8 bg-white border border-border rounded-[3rem] flex flex-col justify-center items-center text-center group hover:border-primary transition-colors shadow-sm">
            ...
            <p className="text-[10px] uppercase font-black text-muted-foreground/40 mt-1 tracking-widest">
              Experts Certifiés
            </p>
          </div>
      ...
      <section className="container px-4 py-12">
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-16">
          <div className="max-w-2xl">
            <span className="text-[10px] font-black text-primary uppercase tracking-[3px]">
              Explorez le savoir
            </span>
          ...
          <Button
            variant="link"
            className="text-lg font-black p-0 h-auto text-primary"
            asChild
          >
            <Link href="/catalogue">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {categories.slice(0, 12).map((category: any) => (
            ...
            >
              ...
              <p className="font-bold text-sm tracking-tight leading-tight px-2">
                {category.name}
              </p>
            </Link>
          ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="flex flex-col gap-6">
            ...
            <p className="text-muted-foreground font-medium leading-relaxed">
              Toutes nos formations répondent aux référentiels de qualité les
              plus exigeants pour garantir votre satisfaction et vos
              financements.
            </p>
          </div>
          <div className="flex flex-col gap-6">
            ...
            <p className="text-muted-foreground font-medium leading-relaxed">
              Un accès direct aux meilleurs formateurs du marché, sélectionnés
              pour leur expertise technique et leur pédagogie innovante.
            </p>
          </div>
          <div className="flex flex-col gap-6">
            <div className="h-14 w-14 rounded-2xl bg-primary text-white flex items-center justify-center shadow-lg shadow-primary/20">
            ...
            <p className="text-muted-foreground font-medium leading-relaxed">
              Suivez l&apos;impact de vos formations en temps réel grâce à notre
              dashboard intelligent et nos outils de reporting automatisés.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-primary/5 py-24 relative overflow-hidden">
        ...
        <div className="container px-4 flex flex-col items-center text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight max-w-4xl text-balance italic">
            &quot;Form-Act a radicalement changé notre approche de la formation
            continue. La qualité des intervenants est simplement inégalée.&quot;
          </h2>
          <div className="mt-10">
            <p className="font-black text-xl">Julien Morel</p>
            <p className="text-sm font-bold text-muted-foreground uppercase tracking-[3px] mt-2">
              DRH — TechCorp Solutions
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 mt-4">
              <Button
                ...
                size="lg"
                variant="secondary"
                className="h-16 px-12 text-lg font-black rounded-2xl hover:bg-white hover:text-primary transition-all"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-16 px-12 text-lg font-black border-2 border-white/30 text-white rounded-2xl bg-white/5 backdrop-blur-sm hover:bg-white/10 hover:border-white transition-all"
              >
