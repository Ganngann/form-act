            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="flex flex-wrap gap-6 pt-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="block text-[10px] font-black text-muted-foreground uppercase opacity-60">
                      Durée
                    </span>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="animate-in fade-in slide-in-from-bottom-4 duration-700">
              <h2 className="text-2xl font-bold tracking-tight mb-6 flex items-center gap-2">
                <BookOpen className="h-6 w-6 text-primary" />À propos du cours
              </h2>
              ...
              <section className="bg-slate-50 p-8 rounded-[2rem] border border-slate-100 flex flex-col md:flex-row gap-8 items-start animate-in fade-in slide-in-from-bottom-8 duration-700">
                <div className="flex-1">
                  ...
                  <p className="text-slate-600 text-sm mb-6">
                    Cette formation est éligible à plusieurs types de
                    financements régionaux. Voici les codes à fournir lors de
                    votre demande.
                  </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {agreements.map((agreement, idx) => (
                      <div
                        key={idx}
                        className="flex items-center justify-between bg-white px-4 py-3 rounded-xl border border-border"
                      >
              ...
              <div className="flex p-8 bg-primary/5 rounded-[2rem] border border-primary/10 items-center justify-between gap-4 animate-in fade-in slide-in-from-bottom-8 duration-700">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Téléchargez le syllabus complet au format PDF.
                  </p>
                </div>
                <a
                  href={formation.programLink}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <Button
                    variant="outline"
                    className="gap-2 rounded-xl h-12 border-primary/20 text-primary hover:bg-white hover:border-primary"
                  >
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-1000">
            <div className="sticky top-8 space-y-8">
              ...
              <div className="bg-white p-6 rounded-[2rem] border border-border shadow-sm text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Nos conseillers pédagogiques sont là pour vous aider à
                    choisir.
                  </p>
                </div>
                <Button
                  ...
                  asChild
                >
                  <a href="mailto:support@form-act.com">
              ...
              <div className="flex items-center justify-center gap-2 text-xs font-medium text-muted-foreground/60">
                <ShieldCheck className="h-3 w-3" /> Paiement sécurisé & Facture
                pro
              </div>
            </div>
          </div>
