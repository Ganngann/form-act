...
export const metadata = {
  ...
  description:
    "Trouvez des réponses rapides à vos questions sur nos formations et services.",
};
              ...
              <Accordion type="single" collapsible className="w-full space-y-4">
                {category.items.map((item, i) => (
                  <AccordionItem
                    key={i}
                    value={`item-${idx}-${i}`}
                    className="border border-border/60 rounded-2xl px-6 bg-white shadow-sm hover:border-primary/50 transition-all data-[state=open]:border-primary data-[state=open]:ring-1 data-[state=open]:ring-primary/20"
                  >
        ...
        <div className="mt-20 p-12 bg-primary rounded-[2.5rem] text-center relative overflow-hidden shadow-2xl shadow-primary/30">
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-white/80 text-lg font-medium">
              Notre équipe support est disponible pour vous aider à résoudre
              votre problème.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button
                asChild
                size="lg"
                className="bg-white text-primary hover:bg-white/90 font-black h-14 px-8 rounded-xl shadow-lg"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="bg-transparent border-2 border-white/30 text-white hover:bg-white/10 hover:border-white font-bold h-14 px-8 rounded-xl"
              >
