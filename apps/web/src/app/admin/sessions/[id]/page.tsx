        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="flex items-center gap-4">
            <Button
              ...
              size="icon"
              asChild
              className="rounded-xl h-10 w-10 border-border bg-white shadow-sm"
            >
            ...
            <div>
              ...
              <div className="flex items-center gap-3 text-muted-foreground font-medium text-sm mt-1">
                ...
                <Badge
                  variant="secondary"
                  className="font-bold text-[10px] tracking-wide uppercase px-2 py-0.5 rounded-full bg-slate-100 text-slate-600"
                >
            ...
            <CardContent className="p-0 flex flex-col md:flex-row">
              ...
              <div className="bg-primary/5 min-w-[160px] p-8 flex flex-col items-center justify-center text-center border-r border-primary/5">
                ...
                <div className="mt-6 flex flex-col gap-1 items-center">
                  <Badge
                    variant="outline"
                    className="bg-white text-xs font-bold border-border/60"
                  >
                    {session.slot === "AM"
                      ? "09:00 - 12:30"
                      : session.slot === "PM"
              ...
              <div className="flex-1 p-8 space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-700 bg-muted/30 p-3 rounded-lg border border-border/50">
                    {session.location ||
                      "Adresse par défaut du client (Non spécifiée)"}
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <CardContent className="pt-4 space-y-4">
                {(() => {
                  ...
                  try {
                      ...
                      <div className="space-y-4">
                        ...
                        {log.accessDetails && (
                          <div className="bg-orange-50/50 p-4 rounded-xl border border-orange-100 text-sm">
                            ...
                            <p className="text-orange-900/80 whitespace-pre-wrap">
                              {log.accessDetails}
                            </p>
                          </div>
                        )}
                    ...
                    return (
                      <pre className="text-xs p-4 bg-red-50 text-red-600 rounded-xl">
                        {session.logistics}
                      </pre>
                    );
                  }
                  ...
                  try {
                    ...
                    return (
                      <div className="space-y-2 max-h-[400px] overflow-y-auto pr-2">
                        {parts.map((p: any, i: number) => (
                          <div
                            key={i}
                            className="flex items-center gap-3 p-3 bg-muted/5 hover:bg-muted/20 rounded-xl border border-border/40 transition-colors"
                          >
                    ...
                    return (
                      <p className="text-destructive text-sm font-bold">
                        Erreur de format des participants
                      </p>
                    );
                  }
                })()}
