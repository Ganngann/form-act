...
async function getUpcomingSessions() {
  ...
  const res = await fetch(
    `${API_URL}/sessions?status=CONFIRMED&start=${today}`,
    {
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-8">
        <div>
          ...
          <p className="text-muted-foreground font-medium text-lg max-w-2xl">
            Vue d&apos;ensemble de l&apos;activité, gestion des sessions et
            suivi des priorités.
          </p>
        </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="h-16 w-16 rounded-xl bg-muted/10 flex flex-col items-center justify-center shrink-0 border border-border/50 group-hover:border-primary/20 group-hover:bg-primary/5 transition-colors">
                          ...
                          <span className="text-[10px] uppercase font-bold text-muted-foreground group-hover:text-primary/70">
                        ...
                        <div className="flex-1 min-w-0 grid md:grid-cols-2 gap-4 w-full">
                          <div>
                            <h3 className="font-bold text-gray-900 truncate group-hover:text-primary transition-colors text-lg">
