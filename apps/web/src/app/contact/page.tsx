...
import { Mail, Phone, MapPin, MessageSquare, Linkedin, Facebook, Twitter } from "lucide-react"

export const metadata = {
    title: "Contactez-nous | Form-Act",
    description: "Prenez contact avec l'équipe Form-Act pour vos besoins en formation.",
}
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <Card className="rounded-[2rem] border-border shadow-lg shadow-black/5 overflow-hidden group hover:border-primary/50 transition-colors">
                            <CardContent className="p-8 space-y-8">
                                <div>
                                    <h3 className="text-sm font-black uppercase tracking-widest text-muted-foreground mb-6">Coordonnées</h3>
                                    <ul className="space-y-6">
                                        <li className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-muted-foreground leading-relaxed">123 Avenue de la Formation,<br />1000 Bruxelles, Belgique</p>
                                            </div>
                                        </li>
                                        ...
                                        <li className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <a href="mailto:contact@form-act.com" className="text-muted-foreground hover:text-primary transition-colors">contact@form-act.com</a>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="pt-8 border-t border-border">
                                    <h3 className="text-sm font-black uppercase tracking-widest text-muted-foreground mb-4">Réseaux Sociaux</h3>
                                    <div className="flex gap-2">
                                        {[Linkedin, Twitter, Facebook].map((Icon, i) => (
                                            <a key={i} href="#" className="h-12 w-12 rounded-xl border border-border flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-white hover:border-primary transition-all">
                        ...
                        <Card className="rounded-[2rem] border-border shadow-sm overflow-hidden bg-white/50 backdrop-blur-sm">
                            <CardContent className="p-8 md:p-12">
                                <div className="mb-8">
                                    ...
                                    <p className="text-muted-foreground">Remplissez le formulaire ci-dessous et nous vous répondrons dans les plus brefs délais.</p>
                                </div>
                                <ContactForm />
                            </CardContent>
                        </Card>
