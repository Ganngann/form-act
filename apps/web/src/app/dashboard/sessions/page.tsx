    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center py-20">
                <p className="text-muted-foreground animate-pulse font-bold">Chargement de vos sessions...</p>
            </div>
        )
    }
                ...
                <TabsContent value="completed" className="mt-0 outline-none">
                    {completedSessions.length > 0 ? (
                        ...
                        <div className="text-center py-20">
                            <p className="text-muted-foreground font-bold">Aucune session passée à afficher.</p>
                        </div>
                    )}
                </TabsContent>
            </Tabs>
