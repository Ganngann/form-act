/*
  ...
  - You are about to drop the column `agreementCode` on the `Formation` table. All the data in the column will be lost.
...
INSERT INTO "new_Formation" ("categoryId", "description", "duration", "durationType", "expertiseId", "id", "imageUrl", "inclusions", "isPublished", "level", "methodology", "price", "programLink", "title") SELECT "categoryId", "description", "duration", "durationType", "expertiseId", "id", "imageUrl", "inclusions", "isPublished", "level", "methodology", "price", "programLink", "title" FROM "Formation";
