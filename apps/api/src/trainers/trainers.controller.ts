import { Controller, Get, Param, Query, Patch, Body, Post, UseInterceptors, UploadedFile, UseGuards, Request, ForbiddenException, BadRequestException } from "@nestjs/common";
...
export class TrainersController {
  ...
  @UseGuards(AuthGuard('jwt'))
  @Patch(':id')
  async updateProfile(@Param('id') id: string, @Body() updateDto: UpdateTrainerDto, @Request() req) {
    const trainer = await this.trainersService.findOne(id);
